...
from app.models import Item, Monster, Weapon, Equipment, Slot
from app.schemas import ItemSchema, MonsterSchema, WeaponSchema, EquipmentSchema, SlotSchema
...
class CrudMonster:
    ...
    def create_monster(db: Session, monster: MonsterSchema):
        ...
        try:
            ...
            raise HTTPException(status_code=status.HTTP_409_CONFLICT, detail="Monster already exists")
...
class CrudWeapon:
    ...
    def create_weapon(db: Session, weapon: WeaponSchema):
        ...
        try:
            ...
            raise HTTPException(status_code=status.HTTP_409_CONFLICT, detail="Weapon already exists")
...
class CrudSlot:
    ...
    def create_slot(db: Session, slot: SlotSchema):
        ...
        try:
            ...
            raise HTTPException(status_code=status.HTTP_409_CONFLICT, detail="Slot already exists")
